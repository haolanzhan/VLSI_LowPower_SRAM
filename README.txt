...
Here is an explanation of the project directory. In order to view this project in Cadence Virtuoso,
Open virtuoso from wherever you normally use Virtuoso. Add the following to your Virtuoso Library path:

Name: project_folder
Path: /vol/eecs391/projects/2022/low_power_SRAM/cadence/low_power_SRAM

It is critical to name the library project_folder, since the files within this folder depends on that Alias name.

From here, any directory names is directly under the given path above. Here is a brief description of each cellview. These directory includes everything needed to run virtuoso. There are also png files 
